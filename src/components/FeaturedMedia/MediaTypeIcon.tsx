...
export type MediaType = "standard" | "video" | "audio" | "gallery";
...
const MediaTypeIcon: FC<MediaTypeIconProps> = ({
  className = "",
  postType = "standard",
  onClick,
  wrapSize = "w-11 h-11",
  ...
  return (
    <div
      className={`nc-MediaTypeIcon ${className}`}
      data-nc-id="MediaTypeIcon"
      onClick={onClick}
    >
