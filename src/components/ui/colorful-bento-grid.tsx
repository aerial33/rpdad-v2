    ...
    <section id="free-tools" className="bg-white rounded-3xl p-4 my-16 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col my-12 w-full items-start justify-start gap-4">
          <div className="flex flex-col md:flex-row gap-2 items-end w-full justify-between ">
            ...
            <p className="max-w-sm font-semibold text-md text-neutral/50">
              Working with us is like having an activation growth taskforce of a Data Scientist, PLG
              Advisor, & Behavioral Designer in-house. Always ready to go.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:items-start md:justify-start gap-4 ">
        <Link
          ...
          className="md:col-span-2  hover:scale-101 hover:shadow-[-6px_6px_32px_8px_rgba(192,192,192,0.2)] hover:rotate-1 transition-all duration-200 ease-in-out h-[330px] overflow-hidden relative bg-foret/20 rounded-xl flex flex-row items-center gap-8 justify-between px-3 pt-3 pb-6"
        >
        ...
        >
          ...
          <div className="w-full object-fill rounded-xl border">want to see me</div>
        </Link>
        ...
        <Link
          ...
          className="pointer-events-none flex items-center justify-center overflow-hidden md:hover:scale-105 hover:shadow-[-6px_6px_32px_8px_rgba(192,192,192,0.2)] hover:-rotate-6 transition-all duration-200 ease-in-out relative bg-primary/20 h-[330px] rounded-xl flex-col  px-5 py-6"
        >
